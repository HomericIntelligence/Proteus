...
# Live effective rules on 2026-07-16: homeric-main-baseline (15556490)
# plus homeric-main-extras (18221113). Keep every required context attached to
# a workflow that handles both PR validation and merge-group validation.
